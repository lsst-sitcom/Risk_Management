...
def montecarlorisk(num_trials,annual_escalation,subsystem,output_file):
	...
	fields="components,summary,customfield_13200,customfield_13404,customfield_13606,customfield_13107,customfield_13108,customfield_13110,customfield_13111,description"
	print(('\n\r Query to database \n\r\n\r'+ query +'\n\r'))
	...
	for i in range(len(issues)):
		rows.append({'riskid':int(''.join([i for i in issues[i].key if i.isdigit()])),
					...
					'current_probability':xstr(issues[i].fields.customfield_13200),
					'current_expense_expected':issues[i].fields.customfield_13404,
					'current_schedule_cost_expected':issues[i].fields.customfield_13606,
					'meanprobability':mean_prob_lookup[issues[i].fields.customfield_13200.value],
					'total_cost':0.0,
	...
	current_probability=[] 				# issue.fields.customfield_13200
	current_expense_expected=[] 		# issue.fields.customfield_13404
	current_schedule_cost_expected=[] 	# issue.fields.customfield_13606
	meanprobability=[] 					# calculate from cf 13200
	total_cost=[] 						# issue.fields.customfield_13606 + issue.customfield_13404
